  ...
  return (
    <>
      ...
      <Grid container sx={styles.feature02Bg}>
        <Grid item mobile={12} md={6} sx={styles.featureContent}>
        ...
        <Grid item mobile={12} md={6} sx={{ px: 2 }}>
          <Box sx={styles.featureBox}>
            <Box sx={styles.featureWrapper}>
              <Box
                component="img"
      ...
      <Grid container sx={styles.feature03Bg}>
        <Grid item mobile={12} md={6} sx={styles.featureContent}>
          ...
          <Typography variant="body1" sx={styles.featureDetail}>
            Our AI will automatically assign your transactions to categories and
            associate them with the proper general ledger accounts
          </Typography>
          <Button
            variant="contained"
            endIcon={<ProjectorScreenChart weight="duotone" />}
